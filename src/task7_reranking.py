...
def rerank_mmr(
    ...
    for i in selected:
        ...
        item["score"] = cosine_sim(query_embedding, candidates[i]["embedding"])
        results.append(item)
    return results
...
def rerank(
    ...
    if method == "cross_encoder":
        ...
        # candidates có thể là 1 list phẳng (1 ranker) hoặc list-of-lists (nhiều ranker,
        # vd. Task 9 gộp dense + BM25) - RRF trên 1 list vẫn hợp lệ, chỉ re-sort theo rank.
